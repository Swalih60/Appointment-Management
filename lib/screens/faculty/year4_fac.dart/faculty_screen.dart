...
class FacultyScreenYear4 extends StatefulWidget {
  const FacultyScreenYear4({super.key});

  @override
  State<FacultyScreenYear4> createState() => _FacultyScreenYear4State();
}

class _FacultyScreenYear4State extends State<FacultyScreenYear4> {
                ...
                child: button1(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => ApprovalFacultyScreenYear4(),
                          ));
                    },
                    text: 'Approval',
