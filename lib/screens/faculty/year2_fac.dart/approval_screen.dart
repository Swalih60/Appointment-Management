...
import 'package:ams/screens/faculty/year2_fac.dart/requests_screen.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';

// ignore: must_be_immutable
class ApprovalFacultyScreenYear2 extends StatelessWidget {
  ApprovalFacultyScreenYear2({Key? key}) : super(key: key);
                        ...
                        return listile(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => RequestFacScreenYear2(
                                  uid: uid,
                                  docId: docID,
                                  from: requestFrom,
                                  to: requestTo,
