...
class EditScheduleDetails extends StatefulWidget {
  final String uid;
  final String docId;
  EditScheduleDetails({Key? key, required this.uid, required this.docId})
      : super(key: key);
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: DropdownButton(
                      ...
                      items: const [
                        DropdownMenuItem(
                            value: 1, child: Text('Vice principal')),
                        DropdownMenuItem(value: 2, child: Text('Principal')),
                        DropdownMenuItem(
                            value: 3, child: Text('Asst. Manager')),
                    ...
                    onPressed: () async {
                      ...
                      if (formkey.currentState?.validate() ?? false) {
                        for (var doc in documentData) {
                          if (doc['toName'] == currentvalue.toString() &&
                              doc['date'] == dateController.text &&
