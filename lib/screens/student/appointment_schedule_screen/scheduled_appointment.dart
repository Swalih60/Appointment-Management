...
import 'package:ams/screens/student/appointment_schedule_screen/edit_scheduler.dart';
                      ...
                      trailing: Row(
                        ...
                        children: [
                          ...
                          IconButton(
                              onPressed: () async {
                                var response =
                                    await FirebaseCrud.deleteScheduleDetails(
                                        docId: docId);
                          ...
                          IconButton(
                              onPressed: () async {
                                var response = await FirebaseCrud.markVisited(
                                    docId: docId);
                                if (response.code == 200) {
                                  Fluttertoast.showToast(
                                    msg: 'Mark visited',
