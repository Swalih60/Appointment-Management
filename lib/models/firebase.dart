...
class FirebaseCrud {
  ...
  static Future<Response> deleteScheduleDetails({required String docId}) async {
    Response response = Response();
    DocumentReference documentReferencer = collection.doc(docId);
  ...
  static Future<Response> markVisited({required String docId}) async {
    Response response = Response();
    DocumentReference documentReferencer = collection.doc(docId);
  ...
  static Future<Response> approveReject({
    ...
    Map<String, dynamic> data = <String, dynamic>{"isApproved": isApproved};
